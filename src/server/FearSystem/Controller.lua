...
function Controller:RegisterEventHandlers()
    ...
    self:_subscribe("DirectorEventTriggered", function(payload)
        self:OnDirectorEventTriggered(payload)
    end)
...
function Controller:OnDirectorEventTriggered(payload)
    local matchId = payload and payload.matchId
    if matchId then
        self._service:OnDirectorEvent(matchId, payload)
    end
end
