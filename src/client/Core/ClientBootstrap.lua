...
local NpcDialogueController = safeRequire(findModule({ "NpcDialogue", "NpcDialogueController" }), "NpcDialogueController")
local RespawnGuard = safeRequire(findModule({ "RespawnGuard", "Main" }), "RespawnGuard")
...
addSystem("NpcDialogueController", NpcDialogueController)
addSystem("RespawnGuard", RespawnGuard)
