...
function UISystem:_applyRoomBrowserSizing(profile, viewportSize, topLeftInset, bottomRightInset)
	...
	if isCompact then
		...
		if roomListHeight < (profile.isMobile and 154 or 140) then
			local deficit = (profile.isMobile and 154 or 140) - roomListHeight
			previewHeight = math.max(profile.isMobile and 212 or 224, previewHeight - deficit)
			roomListY = contentTop + previewHeight + 12
			roomListHeight = math.max(profile.isMobile and 154 or 140, actionY - roomListY - 8)
		end
		...
		setOffsetBounds(joinPassword, headerPadding, actionY - (profile.isMobile and 44 or 42), previewWidth, extraCompactMobile and 34 or (profile.isMobile and 38 or 34))
