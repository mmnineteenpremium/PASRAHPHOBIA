...
function UISystem:_applyRoomBrowserSizing(profile, viewportSize, topLeftInset, bottomRightInset)
	...
	if isCompact then
		if useWideMobileLayout then
			...
			local actionColumnGap = extraCompactMobile and 2 or 6
			local roomListBottomGap = extraCompactMobile and 26 or 34
			local roomListHeight = math.max(130, previewHeight - (joinHeight + actionRowHeight + roomListBottomGap))
			local actionY = contentTop + roomListHeight + (extraCompactMobile and 14 or 18)
			...
			local previewMapHeight = math.clamp(math.floor(previewHeight * 0.34), 107, 134)
			local previewPlayersTopGap = extraCompactMobile and 21 or 28
			local previewPlayersBottomInset = extraCompactMobile and 34 or 40
			...
			if previewMapMood then
				local moodWidth = extraCompactMobile and 120 or 144
