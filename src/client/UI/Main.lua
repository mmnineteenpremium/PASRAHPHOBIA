...
function UISystem:_applyRoomBrowserSizing(profile, viewportSize, topLeftInset, bottomRightInset)
	...
	if isCompact then
		...
		setOffsetBounds(roomPreviewPlayersList, 12, (profile.isMobile and 72 or 66) + previewMapHeight + 24, previewWidth - 24, previewHeight - ((profile.isMobile and 72 or 66) + previewMapHeight + 35))
		if previewMapTitle then
			setOffsetBounds(previewMapTitle, 16, 8, previewWidth - 18, 14)
			previewMapTitle.TextSize = profile.isMobile and 11 or 10
		end
		if previewMapMood then
			local moodWidth = extraCompactMobile and 110 or 144
		...
		if previewMapFooter then
			setOffsetBounds(previewMapFooter, 16, 26, previewWidth - 48, extraCompactMobile and 25 or 44)
