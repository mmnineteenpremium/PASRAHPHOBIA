...
function UISystem:_applyRoomBrowserSizing(profile, viewportSize, topLeftInset, bottomRightInset)
	...
	if isCompact then
		if useWideMobileLayout then
			...
			setOffsetBounds(joinPassword, rightX, actionY - (extraCompactMobile and 40 or 42), rightWidth, extraCompactMobile and 30 or 32)
			...
			local previewPlayersTopGap = extraCompactMobile and 24 or 28
			local previewPlayersBottomInset = extraCompactMobile and 37 or 40
			...
			if previewMapMood then
				local moodWidth = extraCompactMobile and 124 or 144
			...
			if previewMapFooter then
				setOffsetBounds(previewMapFooter, 16, 28, leftWidth - 48, extraCompactMobile and 38 or 44)
