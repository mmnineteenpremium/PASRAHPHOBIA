	...
	if isCompact then
		if useWideMobileLayout then
			...
			if previewMapMood then
				local moodWidth = extraCompactMobile and 116 or 144
		...
		if previewMapTitle then
			setOffsetBounds(previewMapTitle, 16, 8, previewWidth - 36, 14)
		...
		if previewMapFooter then
			setOffsetBounds(previewMapFooter, 16, 30, previewWidth - 48, extraCompactMobile and 33 or 44)
