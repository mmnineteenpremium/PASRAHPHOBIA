...
function UISystem:_applyRoomBrowserSizing(profile, viewportSize, topLeftInset, bottomRightInset)
	...
	if isCompact then
		...
		if roomListHeight < (profile.isMobile and 151 or 140) then
			local deficit = (profile.isMobile and 151 or 140) - roomListHeight
			previewHeight = math.max(profile.isMobile and 212 or 224, previewHeight - deficit)
			roomListY = contentTop + previewHeight + 12
			roomListHeight = math.max(profile.isMobile and 151 or 140, actionY - roomListY - 6)
		end
		...
		setOffsetBounds(joinPassword, headerPadding, actionY - (profile.isMobile and 42 or 42), previewWidth, extraCompactMobile and 34 or (profile.isMobile and 38 or 34))
		...
		setOffsetBounds(roomPreviewPlayersList, 12, (profile.isMobile and 72 or 66) + previewMapHeight + 25, previewWidth - 24, previewHeight - ((profile.isMobile and 72 or 66) + previewMapHeight + 35))
		if previewMapTitle then
			setOffsetBounds(previewMapTitle, 16, 8, previewWidth - 20, 14)
			previewMapTitle.TextSize = profile.isMobile and 11 or 10
		end
		if previewMapMood then
			local moodWidth = extraCompactMobile and 111 or 144
		...
		if previewMapFooter then
			setOffsetBounds(previewMapFooter, 16, 26, previewWidth - 48, extraCompactMobile and 26 or 44)
