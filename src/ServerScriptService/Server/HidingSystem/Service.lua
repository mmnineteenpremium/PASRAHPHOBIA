...
local SAFE_ZONE_VISUAL_COLOR = Color3.fromRGB(132, 186, 154)
...
local SAFE_ZONE_MARKER_OUTLINE_COLOR = Color3.fromRGB(188, 232, 204)
local SAFE_ZONE_MARKER_PANEL_COLOR = Color3.fromRGB(12, 20, 16)
local SAFE_ZONE_MARKER_PANEL_STROKE = Color3.fromRGB(132, 186, 154)
local SAFE_ZONE_MARKER_TITLE_COLOR = Color3.fromRGB(244, 250, 246)
local SAFE_ZONE_MARKER_SUBTITLE_COLOR = Color3.fromRGB(184, 222, 196)
