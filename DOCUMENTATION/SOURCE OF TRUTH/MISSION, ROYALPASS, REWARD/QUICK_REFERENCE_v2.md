...
| 08_MONETIZATION_MANAGER.md   | AGENT_08 ★ BARU    | Passes, Products, Subs, in-game cosmetics, Ads, Analytics |
...
reward_[name] / cosmetic_[name] ← in_game_rewards / RoyalPassConfig rewardId
```
