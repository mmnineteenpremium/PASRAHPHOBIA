# Visual Batch T174 RoomList Bottom Gap Trim VIII 2026-04-27

## Scope

- Continue visual-only lane after the prior RoomBrowser micro-batch.
- Reduce slack beneath the RoomBrowser extra-compact room list.
...
1. Room-list bottom-gap trim:
   - Extra-compact visual value adjusted slightly (7 -> 6).
   - Compacts list-to-action transition while preserving section separation.
...
- Owner validates room-list separation before the lower action stack in extra-compact mobile lane.
