# Visual Batch T118 Map-Title Width Reclaim VIII 2026-04-26

## Scope

- Continue visual-only lane after T117.
...
1. Map-title width reclaim micro trim:
   - Map-preview title horizontal bounds expanded slightly (`previewWidth - 38 -> previewWidth - 36`).
