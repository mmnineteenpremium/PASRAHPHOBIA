# Visual Batch T113 Map-Footer Height Micro Trim X 2026-04-26

## Scope

- Continue visual-only lane after T112.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`36 -> 35`).
