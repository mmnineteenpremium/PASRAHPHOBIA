# Visual Batch T241 Map-Footer Height Micro Trim XXV 2026-04-30
...
1. Footer height micro trim:
   - Extra-compact visual value adjusted slightly (21 -> 20).
...
- Full `scripts/release-preflight.ps1 -Json -CanonicalPlaceOutput ''` is executed after final T243 state.
