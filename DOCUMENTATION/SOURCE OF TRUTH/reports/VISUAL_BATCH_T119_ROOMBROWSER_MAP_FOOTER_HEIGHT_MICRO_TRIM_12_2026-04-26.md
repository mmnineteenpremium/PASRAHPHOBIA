# Visual Batch T119 Map-Footer Height Micro Trim XII 2026-04-26

## Scope

- Continue visual-only lane after T118.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`34 -> 33`).
