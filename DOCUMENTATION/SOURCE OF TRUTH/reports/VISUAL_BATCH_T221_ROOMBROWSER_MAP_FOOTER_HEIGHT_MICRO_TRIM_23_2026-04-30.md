# Visual Batch T221 Map-Footer Height Micro Trim XXIII 2026-04-30
...
1. Footer height micro trim:
   - Extra-compact visual value adjusted slightly (23 -> 22).
...
- Full `scripts/release-preflight.ps1 -Json -CanonicalPlaceOutput ''` is executed after final T223 state.
