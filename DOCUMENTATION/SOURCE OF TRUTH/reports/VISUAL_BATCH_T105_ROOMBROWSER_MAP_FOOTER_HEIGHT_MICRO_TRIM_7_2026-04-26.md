# Visual Batch T105 Map-Footer Height Micro Trim VII 2026-04-26

## Scope

- Continue visual-only lane after T104.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`39 -> 38`).
