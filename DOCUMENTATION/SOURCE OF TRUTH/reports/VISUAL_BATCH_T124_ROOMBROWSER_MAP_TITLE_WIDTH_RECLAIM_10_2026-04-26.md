# Visual Batch T124 Map-Title Width Reclaim X 2026-04-26

## Scope

- Continue visual-only lane after T123.
...
1. Map-title width reclaim micro trim:
   - Map-preview title horizontal bounds expanded slightly (`previewWidth - 34 -> previewWidth - 32`).
