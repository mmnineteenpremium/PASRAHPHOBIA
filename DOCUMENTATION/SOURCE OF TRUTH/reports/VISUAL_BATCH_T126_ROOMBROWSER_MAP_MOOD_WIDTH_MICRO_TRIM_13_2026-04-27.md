# Visual Batch T126 Map-Mood Width Micro Trim XIII 2026-04-27

## Scope

- Continue visual-only lane after T125.
...
1. Mood-chip width micro trim:
   - Extra-compact map-preview mood width reduced slightly (`111 -> 110`).
