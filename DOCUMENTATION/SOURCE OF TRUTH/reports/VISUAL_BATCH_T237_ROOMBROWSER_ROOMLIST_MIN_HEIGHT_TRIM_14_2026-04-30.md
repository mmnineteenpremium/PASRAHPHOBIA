# Visual Batch T237 RoomList Min Height Trim XIV 2026-04-30
...
1. Room-list min-height trim:
   - Extra-compact visual value adjusted slightly (147 -> 146).
...
- Full `scripts/release-preflight.ps1 -Json -CanonicalPlaceOutput ''` is executed after final T238 state.
