# Visual Batch T104 Map-Mood Width Micro Trim VI 2026-04-26

## Scope

- Continue visual-only lane after T103.
...
1. Mood-chip width micro trim:
   - Extra-compact map-preview mood width reduced slightly (`118 -> 117`).
