# Visual Batch T112 Map-Title Width Reclaim VI 2026-04-26

## Scope

- Continue visual-only lane after T111.
...
1. Map-title width reclaim micro trim:
   - Map-preview title horizontal bounds expanded slightly (`previewWidth - 42 -> previewWidth - 40`).
