# Visual Batch T110 Map-Footer Height Micro Trim IX 2026-04-26

## Scope

- Continue visual-only lane after T109.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`37 -> 36`).
