# Visual Batch T122 Map-Footer Height Micro Trim XIII 2026-04-26

## Scope

- Continue visual-only lane after T121.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`33 -> 32`).
