# Visual Batch T117 Map-Mood Width Micro Trim X 2026-04-26

## Scope

- Continue visual-only lane after T116.
...
1. Mood-chip width micro trim:
   - Extra-compact map-preview mood width reduced slightly (`114 -> 113`).
