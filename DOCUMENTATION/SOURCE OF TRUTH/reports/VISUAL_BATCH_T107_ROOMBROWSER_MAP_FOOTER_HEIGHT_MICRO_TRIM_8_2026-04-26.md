# Visual Batch T107 Map-Footer Height Micro Trim VIII 2026-04-26

## Scope

- Continue visual-only lane after T106.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`38 -> 37`).
