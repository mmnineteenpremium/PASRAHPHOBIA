# Visual Batch T202 Map-Mood Width Micro Trim XXV 2026-04-30
...
1. Mood-chip width micro trim:
   - Extra-compact visual value adjusted slightly (105 -> 104).
...
- Full `scripts/release-preflight.ps1 -Json -CanonicalPlaceOutput ''` is executed after final T202 state.
