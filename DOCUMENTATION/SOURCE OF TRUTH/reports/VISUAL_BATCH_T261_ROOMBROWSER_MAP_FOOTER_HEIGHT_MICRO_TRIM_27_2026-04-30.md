# Visual Batch T261 Map-Footer Height Micro Trim XXVII 2026-04-30
...
1. Footer height micro trim:
   - Extra-compact visual value adjusted slightly (19 -> 18).
   - Reclaims vertical space without altering text hierarchy.
...
- Full `scripts/release-preflight.ps1 -Json -CanonicalPlaceOutput ''` is executed after final T263 state.
