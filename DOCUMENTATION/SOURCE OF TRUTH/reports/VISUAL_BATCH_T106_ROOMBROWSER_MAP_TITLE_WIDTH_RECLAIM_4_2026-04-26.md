# Visual Batch T106 Map-Title Width Reclaim IV 2026-04-26

## Scope

- Continue visual-only lane after T105.
...
1. Map-title width reclaim micro trim:
   - Map-preview title horizontal bounds expanded slightly (`previewWidth - 46 -> previewWidth - 44`).
