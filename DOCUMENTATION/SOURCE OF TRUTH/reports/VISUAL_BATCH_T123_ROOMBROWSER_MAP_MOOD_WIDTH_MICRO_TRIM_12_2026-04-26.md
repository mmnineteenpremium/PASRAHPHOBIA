# Visual Batch T123 Map-Mood Width Micro Trim XII 2026-04-26

## Scope

- Continue visual-only lane after T122.
...
1. Mood-chip width micro trim:
   - Extra-compact map-preview mood width reduced slightly (`112 -> 111`).
