# Visual Batch T245 Preview Playerlist Bottom Inset Trim XVIII 2026-04-30
...
1. Player-list bottom-inset trim:
   - Extra-compact visual value adjusted slightly (28 -> 27).
...
- Full `scripts/release-preflight.ps1 -Json -CanonicalPlaceOutput ''` is executed after final T248 state.
