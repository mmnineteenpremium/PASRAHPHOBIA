# Visual Batch T115 Map-Title Width Reclaim VII 2026-04-26

## Scope

- Continue visual-only lane after T114.
...
1. Map-title width reclaim micro trim:
   - Map-preview title horizontal bounds expanded slightly (`previewWidth - 40 -> previewWidth - 38`).
