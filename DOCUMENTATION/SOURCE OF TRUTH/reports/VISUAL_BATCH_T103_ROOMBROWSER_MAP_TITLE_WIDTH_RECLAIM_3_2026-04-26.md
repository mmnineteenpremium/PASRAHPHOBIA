# Visual Batch T103 Map-Title Width Reclaim III 2026-04-26

## Scope

- Continue visual-only lane after T102.
...
1. Map-title width reclaim micro trim:
   - Map-preview title horizontal bounds expanded slightly (`previewWidth - 48 -> previewWidth - 46`).
