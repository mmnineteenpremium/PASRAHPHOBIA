# Visual Batch T108 Map-Mood Width Micro Trim VII 2026-04-26

## Scope

- Continue visual-only lane after T107.
...
1. Mood-chip width micro trim:
   - Extra-compact map-preview mood width reduced slightly (`117 -> 116`).
