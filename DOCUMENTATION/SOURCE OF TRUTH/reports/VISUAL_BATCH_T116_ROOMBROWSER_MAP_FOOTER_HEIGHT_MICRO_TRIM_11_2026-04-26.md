# Visual Batch T116 Map-Footer Height Micro Trim XI 2026-04-26

## Scope

- Continue visual-only lane after T115.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`35 -> 34`).
