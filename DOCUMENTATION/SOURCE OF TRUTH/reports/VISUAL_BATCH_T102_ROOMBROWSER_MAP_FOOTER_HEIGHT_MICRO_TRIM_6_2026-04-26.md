# Visual Batch T102 Map-Footer Height Micro Trim VI 2026-04-26

## Scope

- Continue visual-only lane after T101.
...
1. Map-footer height micro trim:
   - Extra-compact map-preview footer height reduced slightly (`40 -> 39`).
